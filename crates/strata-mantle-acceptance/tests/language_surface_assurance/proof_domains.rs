...
pub(crate) const DOMAINS: &[ProofDomain] = &[
    ...
    ProofDomain {
        id: "authority-effect-admission-binding",
        title: "Authority/effect admission binding",
        feature_ids: &["authority-effect-admission-binding"],
        obligations: proof_obligations::RUNTIME_FUZZ_BOUNDED,
    },
    ProofDomain {
    ...
    ProofDomain {
        id: "typed-component-protocol-port-boundaries",
        title: "Typed component, protocol, and port boundaries",
        feature_ids: &["typed-component-protocol-port-boundaries"],
        obligations: proof_obligations::RUNTIME_FUZZ_BOUNDED,
    },
    ProofDomain {
