...
pub(crate) const FEATURES: &[Feature] = &[
    ...
    feature!(
        ...
        [
            ...
            CompositionReport => ("crates/strata/src/language/composition_artifact/deployment_binding.rs", "RUNTIME_COMPOSITION_BINDING_SCHEMA_ID"),
            ...
            ArtifactAdmission => ("crates/strata/src/language/composition_artifact/deployment_binding.rs", "render_runtime_composition_binding"),
            ArtifactAdmission => ("crates/mantle-runtime/src/composition_binding.rs", "validate_runtime_composition_binding_text"),
            ...
            PositiveTest => ("crates/strata/src/language/tests/composition_artifact.rs", "runtime_binding_emits_explicit_deployment_identity_and_matches_runtime_artifact"),
            PositiveTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "admits_matching_runtime_composition_binding_and_maps_trace_context"),
            ...
            NegativeTest => ("crates/strata/src/language/tests/composition_artifact.rs", "runtime_binding_rejects_rejected_composition_evidence"),
            NegativeTest => ("crates/strata/src/language/tests/composition_artifact.rs", "runtime_binding_rejects_mismatched_runtime_artifact_identity"),
            NegativeTest => ("crates/strata/src/language/tests/composition_artifact.rs", "runtime_binding_rejects_runtime_component_process_out_of_bounds"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_mismatched_runtime_artifact_identity"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_binding_component_instance_that_does_not_match_runtime_artifact"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_noncanonical_binding_schema_identity"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_forged_deployment_id"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_noncanonical_source_fingerprint_algorithm"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_empty_checked_composition_schema_identity"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_forged_checked_composition_schema_identity"),
            NegativeTest => ("crates/mantle-runtime/src/tests/runtime_composition_binding.rs", "rejects_unsupported_checked_composition_schema_version"),
            ...
            FuzzSeed => ("fuzz/seeds/mantle_runtime_composition_binding/valid_admitted.deployment-composition.json", "\"schema_id\":\"mantle.runtime_composition_binding\""),
            FuzzSeed => ("fuzz/seeds/mantle_runtime_composition_binding/mismatched_mta_hash.deployment-composition.json", "\"mantle_artifact_source_hash_fnv1a64\":\"1111111111111111\""),
            FuzzSeed => ("fuzz/seeds/mantle_runtime_composition_binding/forged_composition_schema.deployment-composition.json", "\"composition_schema_id\":\"forged.schema\""),
            FuzzSeed => ("fuzz/seeds/mantle_runtime_composition_binding/nonzero_deployment_id.deployment-composition.json", "\"deployment_id\":7"),
            ...
            BoundedOrProperty => ("crates/strata/src/language/tests/composition_artifact.rs", "runtime_binding_output_is_stable_for_equivalent_checked_graphs"),
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "component_composition_main.check_lower"),
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "component_composition_main.composition_report"),
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "component_composition_main.composition_artifact_build"),
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "component_composition_main.composition_artifact_admit"),
            ...
            Documentation => ("docs/src/development-gates.md", "composition-artifact-gates"),
            Documentation => ("docs/src/file-types.md", "mantle.runtime_composition_binding"),
    ...
    feature!(
        ...
        [
            ...
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "component_composition_main.target_requirements"),
    ...
    feature!(
        ...
        [
            ...
            RuntimeExecution => ("crates/mantle-runtime/src/run/entrypoint.rs", "ExecutableProgram::from_admitted(program)?"),
            ...
            PerformanceSmoke => ("crates/strata-mantle-acceptance/tests/performance_smoke/profiles.rs", "collection_state.in_memory_runtime"),
