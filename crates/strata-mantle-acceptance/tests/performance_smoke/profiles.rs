use super::{
    ...
    authority_effect, boundary_contracts, component_composition, source_data_primitives,
};

pub(super) const ALL_PROFILES: [BenchmarkProfile; 23] = [
    CHECK_LOWER_PROFILE,
