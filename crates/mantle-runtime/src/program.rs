...
use mantle_artifact::{
    ...
    ArtifactEnumVariant, ArtifactMessageVariant, ArtifactPort, ArtifactPrimitiveType,
    ArtifactProcess, ArtifactProcessRef, ArtifactProtocol, ArtifactRecordField, ArtifactScalarType,
    ArtifactSendTarget, ArtifactSpawnKind, ArtifactSpawnSite, ArtifactSupervisorChildMode,
    ArtifactSupervisorStrategy, ArtifactTargetRequirements, ArtifactTransition, ArtifactType,
