...
fn write_json_line(
    ...
    match event {
        ...
        RuntimeEvent::SpawnAuthorityChecked {
            ...
            output,
            "{{\"event\":\"spawn_authority_checked\",\"pid\":{},\"process_id\":{},\"process\":\"{}\",\"target_process_id\":{},\"spawn_site_id\":{},\"authority_id\":{},\"authority_policy_decision_id\":{},\"spawn_kind\":\"{}\",\"authority_result\":\"{}\"{}",
            pid.as_u64(),
            process_id.as_u32(),
            JsonStr(process),
            ...
            authority_id.as_u32(),
            NullableU64(authority_policy_decision_id.map(u64::from)),
            spawn_kind.as_str(),
        ...
        RuntimeEvent::BoundarySendChecked {
            ...
            output,
            "{{\"event\":\"boundary_send_checked\",\"pid\":{},\"process_id\":{},\"process\":\"{}\",\"port_id\":{},\"port\":\"{}\",\"protocol_id\":{},\"protocol\":\"{}\",\"authority_id\":{},\"authority_policy_decision_id\":{},\"target_process_id\":{},\"target_process\":\"{}\",\"message_id\":{},\"message\":\"{}\",\"boundary_result\":\"{}\"{}",
            pid.as_u64(),
            process_id.as_u32(),
            JsonStr(process),
            port_id.as_u32(),
